...
public class Main {
    ...
    private static String[] setCurrentImageURLAndURI(String ext) {
    ...
    private static void fillWeatherTypes(Map<Integer, Integer> weatherTypes) {
    ...
    private static String createWebMap(Double centerLon, Double centerLat, BufferedImage image) {
